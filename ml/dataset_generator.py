    ...
    post_processing_w_augmentations = t.Compose(
        [
            ...
            AugmentatorIf(
                ...
                otherwise=RandomPerspectiveDynamicFillerColor(0.40, p=0.7),
            ),
            RandomPieceCutterDynamicFillerColor(
                IMAGES_DIAGONAL, p=0.1, portion_interval=(0.4, 0.75)
            ),
            RandomScalerDynamicFillerColor(0.0, 0.40, diagonal=IMAGES_DIAGONAL, p=0.6),
